...
class MovieDescriptorTest(unittest.TestCase):
   ...
   # generated by test runs, rather than by unittest.  Refer to the reference
   # images packaged with the sample data set.
